                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              decoration: const InputDecoration(
                                  ...
                                  border: OutlineInputBorder()),
                              onChanged: (val) {
                                controller.presentaddress.value = val;
                                setState(() {});
                              },
                            )),
                          ],
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            onChanged: (val) {
                              controller.governmentid.value = val;
                            },
                          ),
                        ),
                      ), //government id
                          ...
                          children: [
                            Container(
                              ...
                              child: TextField(
                                readOnly: true,
                                // enabled: false,
                                controller: controller.governmentidNameText
                                  ..text = controller.governmentidName.value,
                                style: const TextStyle(fontSize: 14),
                                // controller: controller.textController10,
                                decoration: const InputDecoration(
                                  focusedBorder: OutlineInputBorder(
                                  ...
                                  labelText: "Government Id Attachment *",
                                  labelStyle: TextStyle(
                                      fontSize: 14, color: primarycolor),
                                ),
                              ),
                            ...
                            InkWell(
                              onTap: () {
                                governmentidbottomSheet(context, controller);
                              },
                              child: Container(
                                height: MediaQuery.of(context).size.height / 16,
                                width: MediaQuery.of(context).size.width / 7.0,
